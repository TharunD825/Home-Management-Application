...
<link
	...
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/booking.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/booking_responsive.css">
</head>
<body>
	...
	<div class="super_container">
		...
		<header class="header">
			<div
				...
				<div class="logo">
					<a href="${pageContext.request.contextPath}/home">The River</a>
				</div>
				<div
		...
		<div
			...
			<div class="menu_content">
				<nav class="menu_nav text-right">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/about.jsp">About
								us</a></li>
			...
			<div class="menu_extra">
				<div class="menu_book text-right">
					<a href="${pageContext.request.contextPath}/booking.jsp">Book
						online</a>
				</div>
				<div
											...
											<div
												...
												<div>
													<input type="number" name="room"
														class="booking_input booking_input_b" placeholder="Room"
														required>
												</div>
											</div>
											<div>
						...
						<div class="booking_slider_container">
							<div class="owl-carousel owl-theme booking_slider">
								...
								<div class="booking_item">
									<div class="background_image"
										style="background-image:url('${pageContext.request.contextPath}/images/booking_1.jpg')"></div>
									...
									<div class="booking_link">
										<a href="${pageContext.request.contextPath}/booking">Family
											Room</a>
									</div>
								</div>
								...
								<div class="booking_item">
									<div class="background_image"
										style="background-image:url('${pageContext.request.contextPath}/images/booking_2.jpg')"></div>
									<div class="booking_overlay trans_200"></div>
									<div class="booking_item_content">
										<div class="booking_item_list">
											<ul>
									...
									<div class="booking_price">$120/Night</div>
									<div class="booking_link">
										<a href="${pageContext.request.contextPath}/booking">Deluxe
											Room</a>
									</div>
								</div>
								...
								<div class="booking_item">
									<div class="background_image"
										style="background-image:url('${pageContext.request.contextPath}/images/booking_3.jpg')"></div>
									<div class="booking_overlay trans_200"></div>
									<div class="booking_item_content">
										<div class="booking_item_list">
											<ul>
									...
									<div class="booking_price">$120/Night</div>
									<div class="booking_link">
										<a href="${pageContext.request.contextPath}/booking">Single
											Room</a>
									</div>
								</div>
				...
				<div class="row">
					...
					<div class="col-xl-7 col-lg-6">
						<div class="details_image">
							<div class="background_image"
								style="background-image:url('${pageContext.request.contextPath}/images/details_1.jpg')"></div>
						</div>
					</div>
					...
					<div class="col-xl-5 col-lg-6">
						<div class="details_content">
							...
							<div class="book_now_button">
								<a href="${pageContext.request.contextPath}/booking">Book
									Now</a>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-7 col-lg-6 order-lg-2 order-1">
						<div class="details_image">
							<div class="background_image"
								style="background-image:url('${pageContext.request.contextPath}/images/details_2.jpg')"></div>
						</div>
					</div>
		...
		<div class="special">
			<div class="parallax_background parallax-window"
				...
				data-image-src="${pageContext.request.contextPath}/images/special.jpg"
				data-speed="0.8"></div>
			<div class="container">
				<div class="row">
					...
					<div class="row footer_row">
						...
						<div class="col-lg-3">
							...
							<div class="newsletter_container">
								<form
									action="${pageContext.request.contextPath}/NewsletterServlet"
									method="post" class="newsletter_form" id="newsletter_form">
