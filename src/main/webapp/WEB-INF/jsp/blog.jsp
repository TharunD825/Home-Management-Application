...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/blog.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/blog_responsive.css">
</head>
<body>
...
<div class="super_container">
								...
								<form action="#" class="booking_form" id="booking_form">
									<div class="d-flex flex-xl-row flex-column align-items-start justify-content-start">
										<div class="booking_input_container d-flex flex-row align-items-start justify-content-start flex-wrap">
											<div><input type="text" class="datepicker booking_input booking_input_a booking_in" placeholder="Check in" required></div>
											<div><input type="text" class="datepicker booking_input booking_input_a booking_out" placeholder="Check out" required></div>
											<div><input type="number" class="booking_input booking_input_b" placeholder="Children" required></div>
											<div><input type="number" class="booking_input booking_input_b" placeholder="Room" required></div>
										</div>
					...
					<div class="blog_posts">
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="${pageContext.request.contextPath}/images/blog_1.jpg" alt="">
							...
							<div class="blog_post_content">
								...
								<div class="blog_post_info">
									<ul class="d-flex flex-row align-items-start justify-content-start flex-wrap">
										<li><img src="${pageContext.request.contextPath}/images/icon_4.png" alt=""><a href="#">News</a></li>
										<li><img src="${pageContext.request.contextPath}/images/icon_5.png" alt=""><a href="#">21 Likes</a></li>
										<li><img src="${pageContext.request.contextPath}/images/icon_6.png" alt=""><a href="#">602 views</a></li>
										<li><img src="${pageContext.request.contextPath}/images/icon_7.png" alt=""><a href="#">1 min</a></li>
										<li><img src="${pageContext.request.contextPath}/images/icon_8.png" alt=""><a href="#">3 comments</a></li>
									</ul>
								</div>
								<div class="blog_post_text"><p>Vivamus auctor mi eget odio feugiat...</p></div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="${pageContext.request.contextPath}/images/blog_2.jpg" alt="">
								<div class="blog_post_date"><a href="#">Oct 20, 2018</a></div>
							</div>
							<div class="blog_post_content">
								...
								<div class="blog_post_text"><p>Integer egestas sit amet neque sed elementum...</p></div>
								<div class="button blog_post_button"><a href="#">Read More</a></div>
							</div>
						</div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="${pageContext.request.contextPath}/images/blog_3.jpg" alt="">
								<div class="blog_post_date"><a href="#">Oct 20, 2018</a></div>
							</div>
							<div class="blog_post_content">
								...
								<div class="blog_post_text"><p>Fusce ut turpis felis. Etiam pretium pharetra augue...</p></div>
								<div class="button blog_post_button"><a href="#">Read More</a></div>
							</div>
						</div>
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<div class="special_offer">
							<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/special_offer.jpg')"></div>
	...
	<footer class="footer">
			...
			<div class="container">
				...
				<div class="row footer_row">
					<div class="col-lg-3">
						...
						<ul><li>Beach Str. 345</li><li>67559 Miami</li><li>USA</li></ul>
					</div>
					<div class="col-lg-3">
		...
		<div class="copyright">
			...
			This template is made with <i class="fa fa-heart-o"></i> by 
