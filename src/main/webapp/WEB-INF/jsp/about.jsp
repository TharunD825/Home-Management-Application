...
<link
	...
	rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/about.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/styles/about_responsive.css">
</head>
<body>
	...
	<div class="super_container">
		...
		<div class="home">
			<div class="background_image"
				style="background-image:url('${pageContext.request.contextPath}/images/about.jpg')"></div>
		...
		<div class="about">
			<div class="container">
				...
				<div class="row about_row">
						...
						<div class="about_content">
							<div class="about_text">
								<p>Vestibulum ante ipsum primis in faucibus orci luctus et
									ultrices posuere cubilia Curae; Suspendisse nec faucibus velit.
									Quisque eleifend orci ipsum, a bibendum lacus suscipit sit...</p>
							</div>
							<div class="about_sig">
								<img src="${pageContext.request.contextPath}/images/sig.png"
									alt="">
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div
							class="about_images d-flex flex-row align-items-start justify-content-between flex-wrap">
							<img src="${pageContext.request.contextPath}/images/about_1.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/images/about_2.png"
								alt=""> <img
								src="${pageContext.request.contextPath}/images/about_3.png"
								alt="">
						</div>
					</div>
				</div>
				...
				<div class="row row-xl-eq-height">
					<div class="col-xl-6 order-xl-1 order-2">
						<div class="split_section_image">
							<div class="background_image"
								style="background-image:url('${pageContext.request.contextPath}/images/milestones.jpg')"></div>
						</div>
					</div>
					<div class="col-xl-6 order-xl-2 order-1">
						<div class="split_section_right_content">
							...
							<div
								...
								<div
									class="milestone d-flex flex-row align-items-start justify-content-start">
								...
								<div
									class="milestone d-flex flex-row align-items-start justify-content-start">
									<div class="milestone_content">
										<div class="milestone_counter" data-end-value="21"
											data-sign-after="K">0</div>
				...
				<div class="row">
						...
						<div class="split_section_left_content">
							...
							<div
								...
								<div class="loader_container text-center">
									<div class="loader" data-perc="0.9">
								...
								<div class="loader_container text-center">
									<div class="loader" data-perc="0.8">
										<div class="loader_content">
								...
								<div class="loader_container text-center">
									<div class="loader" data-perc="1.0">
										<div class="loader_content">
					...
					<div class="col-xl-6">
						<div class="split_section_image split_section_left_image">
							<div class="background_image"
								style="background-image:url('${pageContext.request.contextPath}/images/loaders.jpg')"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="testimonials">
			<div class="parallax_background parallax-window"
				...
				data-image-src="${pageContext.request.contextPath}/images/testimonials.jpg"
				data-speed="0.8"></div>
							...
							<div class="owl-carousel owl-theme test_slider">
								<div class="test_slider_item text-center">
									...
									<div class="testimonial_text">
										<p>Etiam nec odio vestibulum est mattis effic...</p>
									</div>
									<div class="testimonial_image">
										<img
											src="${pageContext.request.contextPath}/images/user_1.jpg"
											alt="">
									</div>
								...
								<div class="test_slider_item text-center">
									...
									<div class="testimonial_image">
										<img
											src="${pageContext.request.contextPath}/images/user_2.jpg"
											alt="">
									</div>
									<div class="testimonial_author">
								...
								<div class="test_slider_item text-center">
									...
									<div class="testimonial_image">
										<img
											src="${pageContext.request.contextPath}/images/user_3.jpg"
											alt="">
									</div>
									<div class="testimonial_author">
