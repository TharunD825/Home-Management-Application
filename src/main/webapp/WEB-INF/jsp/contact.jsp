	...
	<div class="super_container">
		...
		<div class="home">
			<div class="background_image"
				style="background-image: url(images/contact.jpg)"></div>
					...
					<div class="col-lg-6">
						<div class="contact_content">
							...
							<div class="contact_form_container">
								<form action="sendMessage" method="post" class="contact_form"
									id="contact_form">
									<div class="row">
							...
							<div class="newsletter_container">
								<form action="subscribeNewsletter" method="post"
									...
									<input type="email" class="newsletter_input"
										placeholder="Your email address" name="newsletterEmail"
										required>
