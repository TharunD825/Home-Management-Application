...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/booking.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/styles/booking_responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<header class="header">
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			<div class="logo"><a href="${pageContext.request.contextPath}/index.jsp">The River</a></div>
			<div class="ml-auto d-flex flex-row align-items-center justify-content-start">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-start justify-content-start">
						<li><a href="${pageContext.request.contextPath}/home">Home</a></li>
						<li><a href="${pageContext.request.contextPath}/about">About us</a></li>
						<li><a href="${pageContext.request.contextPath}/booking">Rooms</a></li>
	...
	<!-- Home -->
	<div class="home">
		<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/booking.jpg')"></div>
					...
					<div class="col">
						<div class="home_content text-center">
							...
							<div class="booking_form_container">
								<!-- Booking form posts to BookingServlet (change to your controller URL if needed) -->
								<form action="${pageContext.request.contextPath}/BookingServlet" method="post" class="booking_form" id="booking_form">
					...
					<div class="booking_slider_container">
						<div class="owl-carousel owl-theme booking_slider">
							...
							<div class="booking_item">
								<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/booking_1.jpg')"></div>
								...
								<div class="booking_link"><a href="${pageContext.request.contextPath}/booking">Family Room</a></div>
							</div>

							<!-- Slide 2 -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/booking_2.jpg')"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_item_content">
									<div class="booking_item_list">
										<ul>
								...
								<div class="booking_price">$120/Night</div>
								<div class="booking_link"><a href="${pageContext.request.contextPath}/booking">Deluxe Room</a></div>
							</div>

							<!-- Slide 3 -->
							<div class="booking_item">
								<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/booking_3.jpg')"></div>
								<div class="booking_overlay trans_200"></div>
								<div class="booking_item_content">
									<div class="booking_item_list">
										<ul>
								...
								<div class="booking_price">$120/Night</div>
								<div class="booking_link"><a href="${pageContext.request.contextPath}/booking">Single Room</a></div>
							</div>
			...
			<div class="row">
				...
				<div class="col-xl-7 col-lg-6">
					<div class="details_image">
						<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/details_1.jpg')"></div>
					</div>
				</div>
				...
				<div class="col-xl-5 col-lg-6">
					<div class="details_content">
						...
						<div class="book_now_button"><a href="${pageContext.request.contextPath}/booking">Book Now</a></div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xl-5 col-lg-6 order-lg-1 order-2">
					<div class="details_content">
						...
						<div class="book_now_button"><a href="${pageContext.request.contextPath}/booking.jsp">Book Now</a></div>
					</div>
				</div>
				...
				<div class="col-xl-7 col-lg-6 order-lg-2 order-1">
					<div class="details_image">
						<div class="background_image" style="background-image:url('${pageContext.request.contextPath}/images/details_2.jpg')"></div>
					</div>
				</div>
	...
	<!-- Special -->
	<div class="special">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="${pageContext.request.contextPath}/images/special.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
	...
	<footer class="footer">
				...
				<div class="row footer_row">
					...
					<div class="col-lg-3">
						...
						<div class="newsletter_container">
							<form action="${pageContext.request.contextPath}/NewsletterServlet" method="post" class="newsletter_form" id="newsletter_form">
		...
		<div class="copyright">
			...
			Copyright &copy;<%= java.time.Year.now().getValue() %> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
			<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		</div>
	</footer>
</div>
